...
async function loadBlogPosts() {
    ...
    try {
        ...
        posts.forEach(post => {
            ...
            <div class="portfolio-box">
                ...
                <div class="portfolio-layer">
                    ...
                    <a href="${post.link}"><i class="bx bx-book-open"></i></a>
                </div>
            </div>
            `;
        });
        ...
        // Initialize ScrollReveal just for the blog cards
        ScrollReveal({
            distance: '80px',
            duration: 2000,
            delay: 200
        ...
        container.innerHTML = "<p style='text-align:center; font-size:1.6rem;'>Unable to load blog posts at this time.</p>";
    }
}
